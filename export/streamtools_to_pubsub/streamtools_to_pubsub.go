...
// original code from nsq/examples/nsq_pubsub.go https://raw.github.com/bitly/nsq/master/examples/nsq_pubsub/nsq_pubsub.go
...
var (
    ...
    topicName       = flag.String("topic", "", "topic you would like to read from")
    nsqdTCPAddrs     = []string{}
    lookupdHTTPAddrs = []string{"127.0.0.1:4161"}
    channelName  = "pubsub_"+*topicName
)
